...
import org.typhon.song.model.repository.SongRepository;
...
public class SongTest {
	...
	public void shouldCreateEntity() throws Exception {
		...
		mockMvc.perform(post("/song").content(
				"{\"firstName\": \"Frodo\", \"lastName\":\"Baggins\"}")).andExpect(
						status().isCreated()).andExpect(
								header().string("Location", containsString("song/")));
	}

	@Test
	public void shouldRetrieveEntity() throws Exception {

		MvcResult mvcResult = mockMvc.perform(post("/song").content(
				"{\"firstName\": \"Frodo\", \"lastName\":\"Baggins\"}")).andExpect(
	...
	public void shouldQueryEntity() throws Exception {
		...
		mockMvc.perform(
				get("/song/search/findByLastName?name={name}", "Baggins")).andExpect(
