package org.typhon.similarity.tests;
...
import org.typhon.similarity.model.repository.SimilarityRepository;
...
public class SimilarityTest {
	...
	public void shouldCreateEntity() throws Exception {
		...
		mockMvc.perform(post("/similarity").content(
				"{\"firstName\": \"Frodo\", \"lastName\":\"Baggins\"}")).andExpect(
						status().isCreated()).andExpect(
								header().string("Location", containsString("similarity/")));
	}

	@Test
	public void shouldRetrieveEntity() throws Exception {

		MvcResult mvcResult = mockMvc.perform(post("/similarity").content(
				"{\"firstName\": \"Frodo\", \"lastName\":\"Baggins\"}")).andExpect(
	...
	public void shouldQueryEntity() throws Exception {
		...
		mockMvc.perform(
				get("/similarity/search/findByLastName?name={name}", "Baggins")).andExpect(
