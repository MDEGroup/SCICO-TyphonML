package org.typhon.track.tests;
...
import org.typhon.track.model.repository.TrackRepository;
...
public class TrackTest {
	...
	public void shouldCreateEntity() throws Exception {
		...
		mockMvc.perform(post("/track").content(
				"{\"firstName\": \"Frodo\", \"lastName\":\"Baggins\"}")).andExpect(
						status().isCreated()).andExpect(
								header().string("Location", containsString("track/")));
	}
	...
	public void shouldQueryEntity() throws Exception {
		...
		mockMvc.perform(
				get("/track/search/findByLastName?name={name}", "Baggins")).andExpect(
