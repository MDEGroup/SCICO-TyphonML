package org.typhon.inventory.tests;
...
import org.typhon.inventory.model.repository.InventoryRepository;
...
public class InventoryTest {
	...
	public void shouldCreateEntity() throws Exception {
		...
		mockMvc.perform(post("/inventory").content(
	...
	public void shouldRetrieveEntity() throws Exception {
		...
		MvcResult mvcResult = mockMvc.perform(post("/inventory").content(
				"{\"firstName\": \"Frodo\", \"lastName\":\"Baggins\"}")).andExpect(
	...
	public void shouldQueryEntity() throws Exception {
		...
		mockMvc.perform(
				get("/inventory/search/findByLastName?name={name}", "Baggins")).andExpect(
